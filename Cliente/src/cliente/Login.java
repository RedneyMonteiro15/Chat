...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tvRegistar = new javax.swing.JLabel();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);
        setTitle("DUMAS");
        setBackground(new java.awt.Color(0, 83, 196));
        setIconImages(null);
        ...
        tvRegistar.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        tvRegistar.setForeground(new java.awt.Color(255, 255, 255));
        tvRegistar.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        tvRegistar.setText("Registar");
        tvRegistar.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseReleased(java.awt.event.MouseEvent evt) {
                tvRegistarMouseReleased(evt);
            }
        });
        ...
        panel1Layout.setHorizontalGroup(
            ...
            .addGroup(panel1Layout.createSequentialGroup()
                .addGroup(panel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(panel1Layout.createSequentialGroup()
                        .addGap(72, 72, 72)
                        .addComponent(btLogin, javax.swing.GroupLayout.PREFERRED_SIZE, 239, javax.swing.GroupLayout.PREFERRED_SIZE)
                        ...
                        .addGroup(panel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(panel1Layout.createSequentialGroup()
                                ...
                                .addGroup(panel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(tvRegistar, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 86, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void btLoginMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btLoginMouseReleased
        // TODO add your handling code here:
        if(edNome.getText().length() != 0 && edPassword.getText().length() != 0){
            com.ligarServidor(edNome.getText(), edPassword.getText());
        }
    }//GEN-LAST:event_btLoginMouseReleased
    
    public void receberDados(String dados){
        if(dados.equals("<NI>")){
            tvStatus.setText("CREDENCIAIS INVÁLIDAS");
        } else if(dados.startsWith("<welcome>")){
            new Janela(com).setVisible(true);
    ...
    private void tvRegistarMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tvRegistarMouseReleased
        // TODO add your handling code here:
        new Registar(com).setVisible(true);
        login.setVisible(false);
        
    }//GEN-LAST:event_tvRegistarMouseReleased
    ...
    private javax.swing.JLabel tvRegistar;
